...
export default function JobStatusUpdater({ jobId, projectId, currentStatus }: JobStatusUpdaterProps) {
  ...
  async function updateStatus(status: string) {
    ...
    setIsLoading(true)
    try {
      const response = await fetch(`/api/projects/${projectId}/jobs/${jobId}/status`, {
        method: "PATCH",
        headers: {
