...
export default function JobForm({ projectId, initialData, jobId }: JobFormProps) {
  ...
  if (!projectId) {
    throw new Error("Project ID is required to create or edit a job")
  }
  ...
  async function onSubmit(values: JobFormValues) {
    try {
      ...
      if (jobId) {
        // Update existing job
        await projectService.updateJob(jobId, formattedValues)
        toast({
          title: "Job updated",
        ...
        // Create new job
        await projectService.createJob(formattedValues)
        toast({
          title: "Job created",
