...
interface ChangeOrderLineItemProps {
  lineItem: Partial<ChangeOrderLineItem>
  onChange: (updatedLineItem: Partial<ChangeOrderLineItem>) => void
  onRemove: () => void
  index: number
}

export default function ChangeOrderLineItemComponent({
  lineItem,
  onChange,
  onRemove,
  index,
}: ChangeOrderLineItemProps) {
